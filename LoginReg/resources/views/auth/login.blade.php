...
<body>
    ...
    <section class="flex items-center justify-center h-screen bg-[rgb(144,184,184)] font-poppins">
                ...
                <form method="POST" action="{{route("auth.loginPost")}}" class="md:space-y-10 space-y-6 pb-10">
                    ...
                    <div class="flex-col space-y-3  ">
                        <div class=" md:text-lg flex justify-between items-center space-x-8">
                            ...
                            <input id="email" placeholder="Enter Your Email" class= "focus:outline-none focus:bg-slate-200 md:text-lg text-sm bg-slate-100 px-6 py-2 rounded-sm" type="email" name="email" required autofocus>
                        </div>
                    
                        <div class=" md:text-lg flex justify-between items-center space-x-8">
                            <label for="password">Password</label>
                            <input id="password"  placeholder="Enter Your Password" class="focus:outline-none focus:bg-slate-200 md:text-lg text-sm bg-slate-100 px-6 py-2 rounded-sm" type="password" name="password" required>
                        </div>
